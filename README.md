...
[HTML Builder](https://github.com/PavelTitov16/HTML-builder)|[Solar System](https://paveltitov16.github.io/node-css-bundle/css-bundle/project-dist/) **(in progress)**|The block consists of five small tasks with increasing difficulty and a final task. Tasks focus on learning specific topics such as: working with files, streams, events, paths and directories to consolidate the basics of **NodeJS**. The RollingScopesSchool courses JavaScript/Front-end. Stage 1|
[Сlean Code]([https://github.com/PavelTitov16/HTML-builder](https://github.com/PavelTitov16/clean-code)|**(in progress)**|The RollingScopesSchool courses JavaScript/Front-end. Stage 1|
New project|            |                   |
